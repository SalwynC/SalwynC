...
A passionate **full-stack web developer** and college student from **India**, actively building innovative e-commerce solutions with the **MERN stack**. I love working with modern web technologies and sharing knowledge with the development community.

## 🚀 What I'm up to:

- 🔨 Building [**ethishop**](https://github.com/SalwynC/ethical-shopping-platform) - An AI-powered ethical e-commerce platform
- 📚 Learning and mastering **full-stack development** with focus on scalability and performance
- 🤝 Open to collaborations and contributing to open-source projects
- 💼 Actively seeking **internship** and **job opportunities** in web development
...
- **Tools:** VS Code, Git, GitHub, MongoDB Atlas, Vercel, npm
- **Other:** Python (Web Scraping), Postman
